...
public class ContactData {
	...
	ContactData()
	{
	//I tried to create object of blob but still geting internal server error.	
	...
	@JsonCreator
	public ContactData(@JsonProperty("image") Blob image, @JsonProperty("contactId") long contactId, @JsonProperty("contactOwner") String contactOwner, @JsonProperty("leadSource") String leadSource,
			@JsonProperty("firstName") String firstName, @JsonProperty("lastName") String lastName,@JsonProperty("accountName") String accountName,
			 @JsonProperty("email") String email,@JsonProperty("title") String title,@JsonProperty("department") String department,
			@JsonProperty("phone") String phone,@JsonProperty("homePhone") String homePhone,@JsonProperty("otherPhone") String otherPhone, @JsonProperty("fax") String fax, @JsonProperty("mobile") String mobile,
			@JsonProperty("dateOfBirth") String dateOfBirth,@JsonProperty("assistant") String assistant,@JsonProperty("asstPhone") String asstPhone,@JsonProperty("reportsTo") String reportsTo, @JsonProperty("emailOptOut") boolean emailOptOut,
			@JsonProperty("createdBy") String createdBy,@JsonProperty("createDate") long createdDate,@JsonProperty("modifyBy") String modifyBy,@JsonProperty("modifyDate") long modifyDate,@JsonProperty("skypeId") String skypeId,@JsonProperty("secondaryEmail") String secondaryEmail,@JsonProperty("lastActivityTime") String lastActivityTime,@JsonProperty("twitter") String twitter,
			@JsonProperty("mailingAddressStreet") String mailingAddressStreet,@JsonProperty("mailingAddressCity") String mailingAddressCity, @JsonProperty("mailingAddressState") String mailingAddressState,@JsonProperty("mailingAddressZip") String mailingAddressZip, @JsonProperty("mailingAddressCounty") String mailingAddressCounty,
			@JsonProperty("otherAddressStreet") String otherAddressStreet,@JsonProperty("otherAddressCity") String otherAddressCity, @JsonProperty("otherAddressState") String otherAddressState,@JsonProperty("otherAddressZip") String otherAddressZip, @JsonProperty("otherAddressCounty") String otherAddressCounty, 		
